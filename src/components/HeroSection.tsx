          ...
          <div className="mx-auto max-w-3xl">
            ...
            <div className="flex justify-center gap-4">
              <button
                ...
                className="inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-iptvzh-green-whatsapp to-iptvzh-green-success px-8 py-4 text-base font-bold text-white shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-200"
                type="button"
              >
